...
> 本仓库只包含应用代码、演示数据、配置模板和演示截图。真实项目库、认证库、上传文件、账号密码、API Key、组织名册和生产部署记录不属于仓库内容。演示数据不代表真实投资事实。

## 界面预览

以下截图来自隔离的演示环境，部门、成员和项目均为虚构示例。

### 组织架构 · 像素办公室

![按部门排列的像素办公室，展示三个演示小组与九个工位](docs/screenshots/organization-pixel-map.png)

[查看团队办公室完整界面](docs/screenshots/organization-office.png)

### 项目中心

![项目中心的项目卡片与阶段概览，使用演示项目数据](docs/screenshots/project-center.png)
